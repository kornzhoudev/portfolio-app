...
const ExperienceCard = ({ experience }: Props) => {
  return (
    ...
    flex-shrink-0 w-[500px] md:w-[600px] xl:w-[900px] bg-[#292929]
    snap-center p-10 hover:opacity-100 opacity-40 cursor-pointer transition-opacity
    ...
    >
      ...
      <div className='px-0 md:px-10'>
        ...
        <ul className='list-disc space-y-4 ml-5 text-lg h-96 overflow-y-scroll pr-5
